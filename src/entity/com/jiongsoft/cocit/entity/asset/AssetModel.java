 ...
 */
@Entity
@CocTable(name = "设备型号信息维护", code = "asset_model", catalog = "_soft_base", pathPrefix = UrlAPI.URL_NS//
/*
 * 操作按钮
 */
, actions = {
...
, fields = {
//
		@CocField(name = "资产分类", mode = "*:N v:S c:M e:M", property = "category", gridOrder = 3)//
...
public class AssetModel extends NameEntity {
