...
public class CocitBizDataNode {
	...
	// 子节点
	private Map<String, CocitBizDataNode> children = new HashMap<String, CocitBizDataNode>();
	...
	private void addChild(String path, String[] value) {
		...
		CocitBizDataNode onn = children.get(subname);
		if (onn == null) {
			onn = new CocitBizDataNode();
		}
		onn.put(path, value);
	...
	public Object inject(Mirror mirror, Object obj, Class genericType, Map<String, String> fieldMode) {
		...
		for (Entry<String, CocitBizDataNode> entry : children.entrySet()) {
			CocitBizDataNode onn = entry.getValue();
