...
public class DCompile {  
    ...
    public Class compile() throws Exception {  
        ...
        final DNameEnvironment env = new DNameEnvironment(targetClassName,  
                java_file_path, Thread.currentThread().getContextClassLoader(),  
                ecode);  
        final IErrorHandlingPolicy policy = DefaultErrorHandlingPolicies  
                .proceedWithAllProblems();  
        final DCompilerRequestor requestor = new DCompilerRequestor(  
                java_basic_path);  
    ...
    public String getTargetClassName() {  
        String targetClassName = java_file_path.substring(java_basic_path  
                .length() + 1, java_file_path.indexOf("."));  
    ...
    public void initialize(String file_path, String basic_path, String ecode) {  
        ...
        compilationUnits[0] = new DCompilationUnit(this.java_file_path, targetClassName,  
                this.ecode);  
        init = true;  
    }  
}  