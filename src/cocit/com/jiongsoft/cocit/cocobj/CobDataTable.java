 ...
 * 
 */
public interface CobDataTable extends CocObject {
	...
	// * @return
	// */
	// List<CobDataTable> getChildrenDataTables();
	 ...
	 * @return
	 */
	List<CobDataGroup> getDataGroups();
	 ...
	 * @return
	 */
	List<CobDataField> getDataFields();
	 ...
	 * @return
	 */
	List<CobDataOperation> getDataOperations();
	 ...
	 * @return
	 */
	List<CobDataField> getDataFieldsForNaviTree();
	 ...
	 * @return
	 */
	List<CobDataField> getDataFieldsForGrid();
}
