...
class DemsyCobDataField implements CobDataField {
	private AbstractSystemData entity;

	DemsyCobDataField(AbstractSystemData entity) {
		this.entity = entity;
	}
	...
	@Override
	public CobDataTable getFkDataTable() {
		SFTSystem sys = entity.getRefrenceSystem();
		if (sys == null)
			return null;

		return new DemsyCobDataTable(sys);
	}
