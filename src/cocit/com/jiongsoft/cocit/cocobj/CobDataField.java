...
/**
 * 组件化自定义软件数据字段，也称“组件化自定义数据字段”、“自定义数据字段”、“数据字段”等。
 * 
 * 
 * <UL>
 ...
 * 
 */
public interface CobDataField extends CocObject {
