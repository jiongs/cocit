...
class JCocitSearchBoxRender extends BaseCuiRender<CuiSearchBoxModel> {
	...
	public void render(Writer out, CuiSearchBoxModel model) throws Throwable {
		...
		print(out, "<input id=\"searchbox_%s\" class=\"jCocit-ui jCocit-searchbox\" data-options=\"bizToken:'%s', prompt:'', height: 24, width:%s, onSearch: jCocit.bizmodule.doSearch", token, token, 250);
