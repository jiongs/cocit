...
public class CuiGridModel extends BaseCuiModel {
	...
	public String getDataQueryUrl() {
		return dataQueryUrl;
	}

	public void setDataQueryUrl(String dataLoadUrl) {
		this.dataQueryUrl = dataLoadUrl;
	}
	...
	public static class GridColumn {
		 ...
		 *            列宽度：单位px，-1 表示自动宽度。
		 */
		public GridColumn(String field, String title, String assign, int width) {
