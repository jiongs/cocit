...
SWFUpload.prototype.initSettings = function() {
	...
	this.ensureDefault("button_image_url", "/jCocit/css/images/blank.gif");
		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				if (flashInstalled) {
					 ...
					 * COCIT: Overwrite.
					 */
					$combo = $('<div class="Cb"><div class="CbB"></div><div class="upload-text"><input type="text" value="" disabled="true" class="CbT" /><input type="hidden" value="" class="CbV" /></div></div>');
					$(".CbB", $combo).css({
